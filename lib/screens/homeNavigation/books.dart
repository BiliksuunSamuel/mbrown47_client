          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                ...
                _widgets.cartButton(context: context,cartSize: booksController.booksCart.length),
              ],
            ),
            body: ListView(
